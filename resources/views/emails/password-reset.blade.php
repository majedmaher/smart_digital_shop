            ...
            <tr>
                <td align="center">
                    ...
                    <table role="presentation" class="container" cellpadding="0" cellspacing="0">
                        ...
                        <tr>
                            <td class="content">
                                <h1 class="content-title">{{ __('messages.password_reset_subject') }}</h1>

                                <p class="greeting">
                                    {{ $userName ? __('messages.hello') . ' ' . $userName . ',' : __('messages.hello') }}
                                </p>

                                <p class="description">{{ __('messages.password_reset_message') }}</p>
                                ...
                                <div class="reset-section">
                                    ...
                                    <p class="reset-expiry">
                                        {{ __('messages.reset_link_expires_in') }}
                                        <span class="reset-timer">60 {{ __('messages.minutes') }}</span>
                                    </p>
                                </div>
                                ...
                                <div class="instructions-card">
                                    <h3 class="instructions-title">
                                        ...
                                        {{ __('messages.alternative_reset_link') }}
                                    </h3>
                                    <p class="reset-link-text">{{ $resetUrl }}</p>
                                    <p class="instructions-text">{{ __('messages.copy_paste_link') }}</p>
                                </div>

                                <!-- Security Notice -->
                                <div class="security-notice">
                                    <div class="security-icon">⚠️</div>
                                    <p class="security-text">{{ __('messages.password_reset_security_notice') }}</p>
                                </div>
                            </td>
                        </tr>
