...
return [
    ...
    'password_reset_message' => 'لقد تلقيت هذا البريد الإلكتروني لأننا تلقينا طلبًا لإعادة تعيين كلمة المرور لحسابك.',
    ...
    'password_reset_failed' => 'فشلت عملية إعادة تعيين كلمة المرور. يرجى المحاولة مرة أخرى.',
    'reset_password_button' => 'إعادة تعيين كلمة المرور',
    'reset_link_expires_in' => 'ينتهي هذا الرابط خلال',
    'alternative_reset_link' => 'رابط بديل',
    'copy_paste_link' => 'إذا لم يعمل الزر أعلاه، يمكنك نسخ ولصق الرابط التالي في متصفحك:',
    'password_reset_security_notice' => 'إذا لم تطلب إعادة تعيين كلمة المرور، فلا حاجة لاتخاذ أي إجراء. سيتم تجاهل هذا الرابط تلقائيًا بعد 60 دقيقة.',
    ...
    'email_not_found' => 'البريد الإلكتروني غير موجود في قاعدة البيانات.',
